"""
Fixed Java COBOL Parser using the original thin JAR with proper classpath management
"""
...
class FixedJavaCOBOLParser:
    """Fixed COBOL parser using Java with proper classpath management"""
    ...
    def _check_proleap(self) -> bool:
        ...
        # Use the original thin JAR instead of the fat JAR
        possible_paths = [
    ...
    def _setup_parser(self):
        ...
        print(f"✅ Fixed Java COBOL parser ready with: {self.proleap_jar}")
    ...
    def parse_file(self, file_path: str) -> Dict[str, Any]:
        """Parse a COBOL file using Java with proper classpath"""
        if not self.using_java:
            return self._fallback_parse(file_path)
        
        try:
            # Create a simple Java program
            java_code = self._create_simple_program(file_path)
            
            # Write Java code to temporary file
            temp_dir = tempfile.mkdtemp()
            java_file = os.path.join(temp_dir, 'FixedParser.java')
    ...
    def _create_simple_program(self, file_path: str) -> str:
        """Create a simple Java program to test the parser"""
        return f"""
import java.io.File;
...
public class FixedParser {{
    public static void main(String[] args) {{
        try {{
            System.out.println("Testing ProLeap with proper classpath...");
    ...
    def _run_java_program(self, java_file: str, cobol_file: str, temp_dir: str) -> Dict[str, Any]:
        ...
        try:
            ...
            run_result = subprocess.run([
                'java', '-cp', f'{temp_dir}{os.pathsep}{self.classpath}', 'FixedParser'
